...
const mcq = [
    ...
    ["I am not discouraged about my future.", "1. I feel more discouraged about my future than I used to.", "2. I do not expect things to work out for me.", "I feel my future is hopeless and will only get worse."],
    ["I do not feel like a failure.", "1. I have failed more than I should have.", "As I look back, I see a lot of failures. ", "I feel I am a total failure as a person. "],
    ...
    ["I don't feel particulary guilty.", "I feel guilty over many things I have done or should have done.", "I feel quite guilty most of the time.", "I feel guilty all of the time."],
    ...
    ['I have not lost interest in other people or activites.', "I am less interested in other people or things than before.", "I have lost most of my interest in other people or things.", "It's hard to get interested in anything."],
    ...
    ["I do not feel I am worthless.", ". I don't consider myself as worthwhile and useful as I used to do.", "I feel more worthless as compared to others. ", "I feel utterly worthless."],
    ...
    <div className="container mx-auto py-8">
      ...
      {!testStarted && !showResult && (
        <div className="space-y-4">
          <p>
            This is the Beck Depression Inventory (BDI), a questionnaire used to assess the severity of depressive symptoms.
            There are {numQuestions} questions. For each question, choose the statement that best describes how you have been feeling over the past two weeks.
          </p>
          <p>Each question is scored from 0 to 3. (Placeholder descriptions for scores)</p>
          ...
          {questions.map((question, index) => (
            <div key={index} className="border p-4 rounded-md">
              ...
              <RadioGroup onValueChange={(value) => handleAnswerChange(index, value)}>
                <div className="flex items-center space-x-2"><RadioGroupItem value="0" id={`q${index}-0`} /><Label htmlFor={`q${index}-0`}>{mcq[index][0]}</Label></div>
                <div className="flex items-center space-x-2"><RadioGroupItem value="1" id={`q${index}-1`} /><Label htmlFor={`q${index}-1`}>{mcq[index][1]}</Label></div>
                <div className="flex items-center space-x-2"><RadioGroupItem value="2" id={`q${index}-2`} /><Label htmlFor={`q${index}-2`}>{mcq[index][2]}</Label></div>
                <div className="flex items-center space-x-2"><RadioGroupItem value="3" id={`q${index}-3`} /><Label htmlFor={`q${index}-3`}>{mcq[index][3]}</Label></div>
              </RadioGroup>
            </div>
          ))}
          <Button onClick={handleSubmit} disabled={Object.keys(answers).length !== numQuestions}>Submit</Button>
        </div>
      )}
